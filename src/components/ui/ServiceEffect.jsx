...
export const ServiceEffect = ({
  ...
  return (
    <div
      ...
      className="relative isolate flex-grow p-10 [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-[400px] h-[450px] [aspect-ratio:17/21]"
      ref={refElement}
      onPointerMove={(event) => {
      ...
      <div
        ...
        <div
          ...
          <div className={cn("h-full w-full bg-[#030A0C]", className)}>
            {children}
          </div>
        </div>
        <div
